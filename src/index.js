...
import ScanProduct from './Components/scan/ScanProduct';
...
ReactDOM.render(
    ...
    <Route exact path="/scan" component= {(props)=>{ return <ScanProduct {...props}/>}} />
    ...
    <Route exact path="/admin" component= {(props)=>{ return <Admin {...props}/>}}/>
